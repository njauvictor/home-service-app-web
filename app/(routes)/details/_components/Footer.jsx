...
function Footer() {
  return (
    <section className="mt-20 px-10 py-20 bg-primary ">
  <div className="container px-4 mx-auto">
    <div className="max-w-7xl mx-auto">
      <div className="pb-10 mb-10 border-b border-white items-center">
        <div className="flex flex-wrap -mx-4 items-center">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="sm:flex -mb-4 items-center lg:justify-end">
              ...
              <a
                className="relative group inline-block w-full sm:w-auto py-3 px-5 mb-4 text-center text-sm font-semibold text-orange-50 hover:text-orange-900 bg-orange-400 rounded-md overflow-hidden transition duration-300"
                href="#"
              >
                <div className="absolute top-0 right-full w-full h-full bg-white transform group-hover:translate-x-full group-hover:scale-105 transition duration-500" />
            ...
            <form action="">
              ...
              <div className="xs:flex items-center">
                <div className="relative mb-4 xs:mb-0 xs:mr-4">
                  ...
                  <input
                    className="w-full p-12 pr-4 py-4 text-sm text-black placeholder-gray-400 rounded-lg bg-white border-gray-700 outline-none"
                    type="email"
                    placeholder="pat@shuffle.dev"
                  />
                </div>
                <button
                  className="flex flex-shrink-0 ml-auto xs:ml-0 items-center justify-center w-12 h-12 text-orange-50 hover:text-orange-900 bg-orange-500 hover:bg-white rounded-full transition duration-200"
                  type="submit"
                >
                  <svg
                    width={24}
